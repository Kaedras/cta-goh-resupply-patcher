...
MOD_ARCHIVES(Valour, std::vector<Archive>{
  ...
  {"ita.pak", "properties/ammo_ita.inc"},
  {"jap.pak", "properties/ammo_jap.inc"},
  {"pol.pak", "properties/ammo_pol.inc"},
  {"usaf.pak", "properties/ammo_usa.inc"},
  {"general.pak", "properties/resupply.inc"}
})
